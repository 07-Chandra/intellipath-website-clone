...
function Program({ program }) {
    ...
    const data = program ? program[0]?.attributes?.Program : "";
    const allPoints = program ? program[0]?.attributes?.Program?.points : " ";

    const achivements = data ? data.achivements : " ";

    const name = program ? program[0]?.attributes?.Program?.name : " ";
    const about = program ? program[0]?.attributes?.Program?.about : " ";
            ...
            <div className="program-container">
                ...
                <div className="wrap-highlight">
                    <div className="highlight card">
                        ...
                        <div className="point">
                            {Object.entries(allPoints).map(([key, value]) => (
